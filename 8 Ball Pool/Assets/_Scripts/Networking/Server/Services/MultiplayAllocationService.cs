...
namespace _Scripts.Networking.Server.Services
{
    public class MultiplayAllocationService : IDisposable
    {
        ...
        public async Task BeginServerCheck()
        {
            ...
            serverCheckManager =
                await multiplayService.StartServerQueryHandlerAsync((ushort)20, "ServerName", "", "0", "");
        ...
        {
            return serverCheckManager.CurrentPlayers;
        }

        public int MaxPlayers()
        {
            return serverCheckManager.MaxPlayers;
        }
